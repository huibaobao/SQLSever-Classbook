...
/*【例4-18】查询成绩表中课程编号以C3起始的学生成绩信息，包括学号、课程号和百分制成绩，
************要求先按课程号升序排序，然后按成绩从高到低降序排序。
*/
select student_id 学号,
		course_id 课程号,
		score 成绩
...
select school_class_id ,sex,count(*) 
from student
	group by sex,school_class_id
go
...
/*【例4-24】统计成绩表中各门课程中及格学生的百分制成绩的平均分、最高分和最低分，
************要求显示平均分超过75分的统计记录，并将查询结果按平均分从高到低排序。
*/
